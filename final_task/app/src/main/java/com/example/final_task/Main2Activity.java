...
//        }
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if(itemId==R.id.all_note){
                    ...
                    alert = builder.setIcon(R.drawable.mk_delete2)
    ...
    private  void updateDrawLayout(){ //更新侧滑界面
        ...
        for(int i=0;i<categoryNames.size();i++){
            ...
            //设置滑动菜单ICON图标
            if(menu.findItem(2+i).getTitle().equals("未分类")){
                menu.findItem(2+i).setIcon(R.drawable.mk_no2) ;
            }else if(menu.findItem(2+i).getTitle().equals("工作")){
                menu.findItem(2+i).setIcon(R.drawable.mk_work) ;
            }else if(menu.findItem(2+i).getTitle().equals("旅游")){
                menu.findItem(2+i).setIcon(R.drawable.mk_travel) ;
            }else if(menu.findItem(2+i).getTitle().equals("学习")){
                menu.findItem(2+i).setIcon(R.drawable.mk_study) ;
            }else{
                menu.findItem(2+i).setIcon(R.drawable.mk_label);
            }
        }
    }
