...
private void get_intentMemo(){
    ...
    private void bindViews() {
        ...
        for(int i=0;i<categoryNames.size();i++){
            if(categoryNames.get(i).toString().equals("未分类"))
                mData.add(new Category(categoryNames.get(i),colorNames.get(i)));
            else if(categoryNames.get(i).toString().equals("工作"))
                mData.add(new Category(categoryNames.get(i),colorNames.get(i)));
            else if(categoryNames.get(i).toString().equals("旅游"))
                mData.add(new Category(categoryNames.get(i),colorNames.get(i)));
            else if(categoryNames.get(i).toString().equals("学习"))
                mData.add(new Category(categoryNames.get(i),colorNames.get(i)));
            else
                mData.add(new Category(categoryNames.get(i),colorNames.get(i)));
        }
        **/
        ...
        for(int i=0;i<categoryNames.size();i++){
            if(categoryNames.get(i).toString().equals("未分类"))
                mData.add(new Category(R.drawable.mk_no2,categoryNames.get(i),colorNames.get(i)));
            else if(categoryNames.get(i).toString().equals("工作"))
                mData.add(new Category(R.drawable.mk_work,categoryNames.get(i),colorNames.get(i)));
            else if(categoryNames.get(i).toString().equals("旅游"))
                mData.add(new Category(R.drawable.mk_travel,categoryNames.get(i),colorNames.get(i)));
            else if(categoryNames.get(i).toString().equals("学习"))
                mData.add(new Category(R.drawable.mk_study,categoryNames.get(i),colorNames.get(i)));
            else
                mData.add(new Category(R.drawable.mk_label,categoryNames.get(i),colorNames.get(i)));
        }
       // mData.add(new Category( R.mipmap.staricon,"新建")
        ...
        myAdapter = new MyAdapter<Category>(mData, R.layout.item_spin_class) {
            ...
            public void bindView(ViewHolder holder, Category obj) {
               ...
               //holder.setTextColor(R.id.txt_name, obj.getCName());
               // holder.setTextPosition(R.id.spinner_category, obj.getCName());
            }
        };
       ...
       // Toast.makeText(getApplicationContext(),"当前默认序号是"+String.valueOf(pos),Toast.LENGTH_SHORT).show();
        ...
        spin_category.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                //textView.setPadding(25,5,25,25);
